    ...
    Tables: {
      ...
      organization_funnel_stages: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "organization_funnel_stages_default_lead_source_id_fkey"
      ...
      product_combos: {
        ...
        Relationships: [
          {
            foreignKeyName: "product_combos_brand_id_fkey"
            columns: ["brand_id"]
            isOneToOne: false
            referencedRelation: "product_brands"
            referencedColumns: ["id"]
      ...
      sales: {
        Row: {
          ...
          seller_delivery_confirmed_date: string | null
