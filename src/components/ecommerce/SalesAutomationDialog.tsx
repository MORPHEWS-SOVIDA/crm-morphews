    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-6 pt-4">
          ...
          {/* Funnel Stage for E-commerce Sales */}
          <div className="space-y-3">
            <Label className="text-base font-semibold">Venda E-commerce Confirmada</Label>
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Quando o pagamento é confirmado no e-commerce, o lead será movido para esta etapa
              </p>
            </div>
