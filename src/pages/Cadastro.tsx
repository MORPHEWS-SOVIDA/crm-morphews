...
import { ArrowLeft, UserPlus, Loader2, Eye, EyeOff, Upload, User, Users } from 'lucide-react';
    ...
    try {
      ...
      if (authData.user) {
        ...
        toast({
          ...
          description: `${formData.firstName} ${formData.lastName} foi cadastrado como ${selectedRole === 'admin' ? 'Administrador' : 'Vendedor'}.`,
        });
      ...
      <div className="space-y-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            {/* Role Selection */}
            <div className="bg-card rounded-xl p-6 shadow-card space-y-4">
              <h2 className="text-lg font-semibold text-foreground">Tipo de Acesso</h2>
                  ...
                  <SelectContent>
                    <SelectItem value="user">
                      <div className="flex flex-col">
                        ...
                        <span className="text-xs text-muted-foreground">Acesso ao CRM sem gerenciar usuários</span>
                      </div>
                    </SelectItem>
              ...
              <div className="p-4 rounded-lg bg-muted/50 space-y-2 text-sm">
                ...
                {selectedRole === 'admin' ? (
                  <ul className="list-disc list-inside text-muted-foreground space-y-1">
                    ...
                    <li>Editar e excluir usuários</li>
                    <li>Configurar origens e produtos</li>
                  </ul>
                ) : (
                  <ul className="list-disc list-inside text-muted-foreground space-y-1">
                    <li>Gerenciar leads</li>
                    <li>Ver origens e produtos</li>
