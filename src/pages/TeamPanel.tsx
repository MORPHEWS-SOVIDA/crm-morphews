...
export default function TeamPanel() {
  ...
  // If user doesn't have a team assigned
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <h3 className="text-lg font-semibold text-foreground mb-2">Nenhum time vinculado</h3>
              <p className="text-muted-foreground text-center max-w-md">
                Você precisa estar vinculado a um time para acessar este painel. 
                Entre em contato com o administrador para configurar seu time.
              </p>
            </CardContent>
          </Card>
        </div>
