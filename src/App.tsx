...
const SalesLanding2026 = lazy(() => import("./pages/SalesLanding2026"));
...
const CheckoutEventsPage = lazy(() => import("./pages/ecommerce/CheckoutEventsPage"));
          ...
          <BrowserRouter>
            <CustomDomainRedirect>
              ...
              <ErrorBoundary title="Ops! Algo deu errado">
                ...
                />
                <Route
                  path="/expedicao/etiquetas-seriais/estoque"
                  element={
                    <ProtectedRoute requiredPermissions={['deliveries_view_all']}>
                      <SerialStockPage />
                    </ProtectedRoute>
                ...
                />
                <Route
                  path="/expedicao/etiquetas-seriais/transferencias-local-de-estoque"
                  element={
                    <ProtectedRoute requiredPermissions={['deliveries_view_all']}>
                      <SerialTransfersPage />
                    </ProtectedRoute>
