...
function parseCommandFallback(text: string): ParsedCommand {
  ...
  // nome ... (até fim ou antes de "colocar"/"cep"/"estrela")
...
serve(async (req) => {
  ...
  try {
    ...
    // Mapear remetente -> usuário -> organização
    ...
    console.error("zapi-assistant-webhook error:", msg);
